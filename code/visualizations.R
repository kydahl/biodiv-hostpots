...
ddata_labels$color <- c("black", Phylo_color, Func_color, Phylo_color, rep(TEK_color, 2), Func_color, Phylo_color, Func_color, Phylo_color)
  # rev(c("#E41A1C", "#E41A1C", "black", rep("#4DAF4A", 3), rep("#377EB8", 4)))
